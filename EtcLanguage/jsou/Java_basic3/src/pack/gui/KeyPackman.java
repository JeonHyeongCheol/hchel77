...
public class KeyPackman extends JFrame implements KeyListener, Runnable {
	Image img;  // 캐릭터 이미지
	Image food; // 먹이 이미지
	int sel = 1;
	...
	public KeyPackman() {
		...
		// 창 아이콘 그림 변경
		this.setIconImage(Toolkit.getDefaultToolkit().getImage("c:/work/pack/pack1.jpg"));
	...
	public void paint(Graphics g) {
		String fn = "c:/work/pack/pack" + String.valueOf(sel) + ".jpg";
	...
	private void bgmSnd() {
		...
		AudioFormat format;
		DataLine.Info info;
		bgm = new File("c:/work/pack/beginning.wav");
