...
public class DbProblem_3_JungO extends JFrame{
	...
	public DbProblem_3_JungO() {
		...
		addWindowListener(new WindowAdapter() {
			...
			public void windowClosing(WindowEvent e) {
				int res = JOptionPane.showConfirmDialog(DbProblem_3_JungO.this, "정말 종료하시겠습니까?", "종료", JOptionPane.YES_NO_OPTION);
