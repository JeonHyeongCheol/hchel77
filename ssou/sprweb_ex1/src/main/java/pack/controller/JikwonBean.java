...
public class JikwonBean {
	private String jikwon_no, jikwon_name, buser_num, buser_name, jikwon_jik, jikwon_pay;
	private String jikwon_ibsail, jikwon_gen, jikwon_rating;
	...
	public String getJikwon_rating() {
		return jikwon_rating;
	}
	
	public void setJikwon_rating(String jikwon_rating) {
